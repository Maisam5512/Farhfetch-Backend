...
export interface ApiFreelancerFreelancer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    portfolioItem: Schema.Attribute.Component<'shared.portfolio', true>;
    publishedAt: Schema.Attribute.DateTime;
    skillname: Schema.Attribute.Component<'shared.skill', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHotelHotel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    costPerNight: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Item: Schema.Attribute.Relation<'oneToMany', 'api::category.category'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    estimatedDeliveryMax: Schema.Attribute.Date;
    estimatedDeliveryMin: Schema.Attribute.Date;
...
export interface ApiTravelerTraveler extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::traveler.traveler': ApiTravelerTraveler;
